...
/**
 * 1. those year is not divisible by 100 and if the year is divisible by 4: then it will be a leap year
 * 2. if the year us divisible by 400, then it is a leap year
